...
namespace Differences.DataAccess.Migrations
{
    ...
    [Migration("20171005112028_InitilizeDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Differences.Interaction.EntityModels.Article", b =>
                {
                    b.Property<int>("Id")
                        .IsConcurrencyToken()
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Differences.Interaction.EntityModels.ArticleUpdateHistory", b =>
                {
                    b.Property<int>("Id")
                        .IsConcurrencyToken()
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Differences.Interaction.EntityModels.Comment", b =>
                {
                    b.Property<int>("Id")
                        .IsConcurrencyToken()
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Differences.Interaction.EntityModels.Article", b =>
                {
                    b.HasOne("Differences.Interaction.EntityModels.User", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("Differences.Interaction.EntityModels.ArticleUpdateHistory", b =>
                {
                    b.HasOne("Differences.Interaction.EntityModels.Article")

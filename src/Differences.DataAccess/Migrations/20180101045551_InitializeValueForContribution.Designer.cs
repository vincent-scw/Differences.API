...
namespace Differences.DataAccess.Migrations
{
    ...
    [Migration("20180101045551_InitializeValueForContribution")]
    partial class InitializeValueForContribution
    {
            ...
            modelBuilder.Entity("Differences.Interaction.EntityModels.UserContributionLog", b =>
                {
                    ...
                    b.HasOne("Differences.Interaction.EntityModels.UserScore", "UserScore")
                        .WithMany("ContributionLog")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
